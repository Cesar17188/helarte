...
@Component({
  selector: 'app-arepa-form',
  templateUrl: './arepa-form.component.html',
  styleUrls: ['./arepa-form.component.scss']
})
export class ArepaFormComponent implements OnInit {
